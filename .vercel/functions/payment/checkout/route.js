...
export async function GET(request) {
    try {
        ...
        return Response.json({ error: error instanceof Error ? error.message : 'Failed to redirect to checkout' }, { status: 500 });
    }
}
export async function POST(request) {
    try {
        ...
        return Response.json({ error: error instanceof Error ? error.message : 'Failed to create checkout session' }, { status: 500 });
    }
}
