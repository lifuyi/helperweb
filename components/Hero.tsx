      ...
      <div className="container mx-auto px-6 relative z-10 pt-20">
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-slate-200 mb-8 leading-relaxed">
            Don't get stuck unable to pay for a taxi or meal. Our step-by-step guide helps you link international cards to WeChat Pay and Alipay. We also offer high-speed VPN access for your trip.
          </p>
